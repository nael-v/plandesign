...
>(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={cn("border-b border-border bg-surface/50 font-medium text-foreground", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn("px-4 py-3 text-left font-medium text-muted [&:has([role=checkbox])]:pr-0", className)}
    {...props}
  />
));
